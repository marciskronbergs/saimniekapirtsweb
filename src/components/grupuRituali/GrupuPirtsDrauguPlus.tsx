...
const GrupuPirtsDrauguPlus = () => {
  ...
  const includedItems = t('draugu-plus.includedItems', { returnObjects: true });
  const features = t('draugu-plus.features', { returnObjects: true });
    ...
    <div className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            {images.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`${t('draugu-plus.cardTitle')} ${index + 1}`}
      ...
      <div className={`bg-[#132d13] rounded-2xl p-8 lg:p-12 mb-16 transform transition-all duration-1000 ${
        ...
        <h3 className="text-2xl font-bold text-white mb-8 text-center">
          {t('draugu-plus.additionalTitle')}
        </h3>
        
        <div className="space-y-6 text-gray-300">
          <div>
            <span className="font-semibold text-green-400">{t('draugu-plus.additionalRental')}</span>
          </div>
        </div>
      </div>
      ...
      <div className={`bg-[#132d13] rounded-2xl p-8 lg:p-12 mb-16 transform transition-all duration-1000 ${
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <h3 className="text-2xl font-bold text-white">{t('draugu-plus.accommodationTitle')}</h3>
        </div>
        
        <div className="text-center">
          <div className="text-3xl font-bold text-green-400 mb-2">
            {t('draugu-plus.accommodationPrice')}
          </div>
          <p className="text-gray-300">{t('draugu-plus.accommodationNote')}</p>
        </div>
      </div>
      ...
      <div className="text-center">
        <div className={`transform transition-all duration-1000 ${
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            {t('draugu-plus.ctaTitle')}
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            {t('draugu-plus.ctaSubtitle')}
          </p>
          <button 
            onClick={handleReserveClick}
...
export default GrupuPirtsDrauguPlus;