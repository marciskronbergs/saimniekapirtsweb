...
const GrupuPirtsDraugu = () => {
  ...
  const includedItems = t('draugu.includedItems', { returnObjects: true });
  const features = t('draugu.features', { returnObjects: true });
    ...
    <div className="py-20 px-6 max-w-7xl mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden group">
            ...
            {images.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`${t('draugu.cardTitle')} ${index + 1}`}
      ...
      <div className={`bg-[#132d13] rounded-2xl p-8 lg:p-12 mb-16 transform transition-all duration-1000 ${
        ...
        <h3 className="text-2xl font-bold text-white mb-8 text-center">
          {t('draugu.additionalTitle')}
        </h3>
        
        <div className="space-y-6 text-gray-300">
          <div>
            <span className="font-semibold text-green-400">{t('draugu.additionalRental')}</span>
          </div>
        </div>
      </div>
      ...
      <div className={`bg-[#132d13] rounded-2xl p-8 lg:p-12 mb-16 transform transition-all duration-1000 ${
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          <h3 className="text-2xl font-bold text-white">{t('draugu.accommodationTitle')}</h3>
        </div>
        
        <div className="text-center">
          <div className="text-3xl font-bold text-green-400 mb-2">
            {t('draugu.accommodationPrice')}
          </div>
          <p className="text-gray-300">{t('draugu.accommodationNote')}</p>
        </div>
      </div>
...
export default GrupuPirtsDraugu;